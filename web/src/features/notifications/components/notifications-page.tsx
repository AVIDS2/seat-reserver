...
const actionRoutes: Record<string, string> = {
  ...
  'view-product': '/dashboard/accounts',
  billing: '/dashboard/runs',
  open: '/dashboard/runs',
  'open-chat': '/dashboard/tasks'
};
...
export default function NotificationsPage() {
  ...
  return (
    <PageContainer
      pageTitle='通知中心'
      pageDescription='查看预约任务、账号授权和系统运行的重要状态。'
      pageHeaderAction={
        count > 0 ? (
    ...
    >
      <Tabs defaultValue='all'>
        <TabsList>
          ...
          <TabsTrigger value='read'>已读 ({readNotifications.length})</TabsTrigger>
        </TabsList>
