      ...
      description={
        <div className='flex flex-col gap-4'>
          <p className='text-muted-foreground'>
            添加学校账号后，平台会自动检查连接。需要你处理时，工作台会给出明确提醒。
          </p>
  ...
  return (
    <Card className='w-full max-w-md py-8' variant='default'>
      <CardHeader>
        ...
        <p className='text-muted-foreground mt-2 text-sm'>连接你的学校预约服务。</p>
      </CardHeader>
      <CardContent>
        <form className='flex flex-col gap-4' onSubmit={(event) => event.preventDefault()}>
          <div className='bg-muted/40 flex items-center justify-between rounded-lg px-3 py-2.5'>
            ...
            <span className='text-muted-foreground text-[11px]'>已连接</span>
          </div>
          <Input
            type='text'
            name='schoolUsername'
