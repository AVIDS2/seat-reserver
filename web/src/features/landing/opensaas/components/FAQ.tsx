...
export function FAQ({ faqs }: { faqs: FAQ[] }) {
  return (
    <div
      id='faq'
      className='mx-auto mt-32 max-w-4xl scroll-mt-24 px-6 pt-12 pb-8 sm:pb-24 lg:max-w-7xl lg:px-8 lg:py-32'
    >
          ...
          >
            ...
            <AccordionContent className='text-muted-foreground'>
              <div className='flex flex-col items-start justify-between gap-4'>
                <p className='text-muted-foreground flex-1 text-base leading-7'>{faq.answer}</p>
                {faq.href && (
                  <a
                    href={faq.href}
