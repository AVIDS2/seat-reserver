...
11. 用户每天在“会员与邀请”的活动中心签到获得 30 席定币；完成创建任务、连接图书馆、开启签到保护和首次成功预约等支线活动，可分别获得 10–60 席定币。邀请的好友完成首次验证后邀请人获得 50 席定币；达到 600 席定币兑换门槛后可以生成一次性邀请码并赠给好友。门槛按约 60 元价值锚定，邀请码明文只显示一次，默认有效 30 天。
