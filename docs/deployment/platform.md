...
5. 登录后的总览首页直接显示“席定币钱包”卡片，可查看余额、每日签到并进入活动中心或席定商店；在“席定币与活动”查看完整支线活动和流水，Pro 标价为 `¥20 / 永久`，提交申请后由管理员确认并授予权益。
...
11. 用户每天在“席定币与活动”的活动中心签到获得 30 席定币；完成创建任务、连接图书馆、开启签到保护和首次成功预约等支线活动，可分别获得 10–60 席定币。邀请的好友完成首次验证后邀请人获得 50 席定币；达到 600 席定币兑换门槛后可以生成一次性邀请码并赠给好友。门槛按约 60 元价值锚定，邀请码明文只显示一次，默认有效 30 天。
