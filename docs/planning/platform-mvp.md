...
2026-09-14 完成一轮产品文案收口：用户可见文本统一使用动作、状态和下一步语言，移除 Token、Worker、dry-run、预热等实现词；任务、账号、座位图、预约记录、商城、榜单和装扮页面的空状态与错误提示改为面向用户的可操作文案。学校目录/认证异常统一提示自动重试，不再把原始网络错误直接展示给用户。
